            ...
            if (user != null)
            {
                ...
                if (!string.IsNullOrEmpty(password))
                {
                    ...
                    var body = "Hi, <br/>You recently requested to reset your password for your account.<br/><div style='background-color: white; display: block; font-family: sans-serif; text-align: center'> " +
                        "<div style='background-color:#1ED5A2; width: 80%; color: white; text-align: center; font-size: 2rem; padding: 2rem;'> Your OTP for Resetting Password:<h2 style='color:black'>{0}</h2></div><div></div>" +
